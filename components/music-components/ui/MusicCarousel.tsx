...
export const AlbumCarousel = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          <div className="animate-glow-pulse w-16 h-16 rounded-full bg-gradient-primary mx-auto mb-4"></div>
          <p className="text-muted-foreground">Loading trending albums...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="h-fit mt-10 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="w-full max-w-7xl h-96 md:h-[400px] relative " style={{ perspective: '1000px' }}>
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute left-4 top-1/2 -translate-y-1/2 z-30 w-10 h-10 rounded-full bg-music-primary/60 hover:bg-music-primary/80 text-white border-0"
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute right-4 top-1/2 -translate-y-1/2 z-30 w-10 h-10 rounded-full bg-music-primary/60 hover:bg-music-primary/80 text-white border-0"
          onClick={() => updateCarousel(currentIndex + 1)}
        >
