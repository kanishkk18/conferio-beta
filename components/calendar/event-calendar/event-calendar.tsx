...
import Participants from "@/components/calendar/participants";
...
export function EventCalendar({
  ...
  return (
    <div
      className="flex has-data-[slot=month-view]:flex-1 flex-col rounded-xl  overflow-y-auto max-h-screen"
      style={
        {
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center sm:gap-2 max-sm:order-1">
                <Button
                  variant="ghost"
                  size="icon"
                  className="max-sm:size-8 dark:bg-black border shadow"
                ...
                >
                 ...
                 <Button
                className="max-sm:h-8 max-sm:px-2.5! dark:bg-white"
                onClick={handleToday}
              >
                Today
              </Button>
            ...
            <div className="flex items-center justify-between gap-2">
              <Button
                variant="outline"
                className="max-sm:h-8 max-sm:px-2.5! dark:bg-black"
                onClick={() => {
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    className="gap-1.5 max-sm:h-8 max-sm:px-2! max-sm:gap-1 dark:bg-black"
                  >
