...
import { StartHour, EndHour } from "@/components/calendar/event-calendar/constants";
...
export function WeekView({
  ...
  return (
    <div data-slot="week-view" className="flex h-full flex-col">
      <div className="bg-transparent border-border/70 sticky top-0 z-30 grid grid-cols-8 border-y backdrop-blur-md uppercase">
      ...
      <div className="grid flex-1 grid-cols-8 overflow-hidden">
        <div className="border-border/70 border-r grid auto-cols-fr">
          {hours.map((hour, index) => (
            ...
            >
              {index > 0 && (
                <span className=" text-muted-foreground/70 absolute -top-3 left-0 flex h-6 w-16 max-w-full items-center justify-end pe-2 text-[10px] sm:pe-4 sm:text-xs">
                  {format(hour, "h a")}
                </span>
              )}
            </div>
