...
function Calendar({
  ...
  return (
    <div className="pt-14 min-h-full h-screen w-fit overflow-hidden">
      <DayPicker
        showOutsideDays={showOutsideDays}
      ...
      <Drawer>
        ...
        <DrawerContent className="absolute bottom-0 right-[0%] overflow-y-auto z-50 h-auto  bg-white dark:bg-black/80 w-[495px] rounded-t-[10px] p-2 border">
