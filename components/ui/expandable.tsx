    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[2rem] p-1 md:p-2 shadow-md shadow-black/5">
            <div className="rounded-md sm:rounded-lg md:rounded-3xl bg-white dark:bg-neutral-900 p-2 md:p-2 shadow-xl ring-1 ring-black/5">
...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("p-3 pt-0 px-3 overflow-hidden flex-grow", className)}
    {...props}
  >
    <motion.div layout>{children as React.ReactNode}</motion.div>
  </div>
))
