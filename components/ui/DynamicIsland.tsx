...
export default function DynamicIsland({
  ...
  return (
    <div className={`h-[100px] z-50  ${className}`}>
      <div className="relative flex h-full w-full flex-col justify-center">
        <motion.div
          ...
          className="mx-auto w-fit mt-12 min-w-[100px] overflow-hidden rounded-full bg-black"
        >
          <motion.div
            transition={{
              type: "spring",
        ...
        <div className="bg-black absolute top-1 left-1/2 z-10 flex -translate-x-1/2 justify-center gap-2 rounded-full border p-1">
          {[
            ...
            <button
              type="button"
              className="bg-blue-600 flex size-8 cursor-pointer items-center justify-center rounded-full border px-2"
              onClick={() => {
                if (view !== key) {
